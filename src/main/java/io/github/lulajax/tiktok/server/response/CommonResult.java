...
import io.github.lulajax.tiktok.server.exception.ExceptionCodeEnum;
...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> failed() {
        return failed(ExceptionCodeEnum.FAILED.getMessage());
    }
    ...
    public static <T> CommonResult<T> validateFailed() {
        return failed(ExceptionCodeEnum.VALIDATE_FAILED.getMessage());
    }
